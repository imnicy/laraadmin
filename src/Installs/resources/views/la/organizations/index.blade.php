...
@section("contentheader_title", trans('label.organizations'))
@section("contentheader_description", trans('label.organizations_listing'))
@section("section", trans('label.organizations'))
@section("sub_section", trans('label.listing'))
@section("htmlheader_title", trans('label.organizations_listing'))

@section("headerElems")
@la_access("Organizations", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">{{ trans('label.organization_add') }}</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">{{ trans('label.organization_add') }}</h4>
			</div>
